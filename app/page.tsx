  ...
  if (!user) {
    return (
      <main className="min-h-screen flex flex-col items-center justify-center text-center p-8">
        ...
        <h1 className="mil text-5xl tracking-wide"><span className="gold-shine">REY</span><span className="text-white">GUILD</span></h1>
    ...
    <main className="min-h-screen flex flex-col p-4 md:p-10">
      ...
      <div className="max-w-7xl mx-auto w-full">
        <div className="flex flex-col items-center mb-5">
          {companyName ? (
            <div className="mil gold-shine text-3xl md:text-4xl tracking-wide text-center">{companyName}</div>
          ) : (
            <>
              <img src="/crest.png" alt="ReyGuild" className="w-16 md:w-20 h-auto drop-shadow" />
              <div className="mil mt-1 text-lg tracking-wide"><span className="gold-shine">REY</span><span className="text-white">GUILD</span></div>
            </>
          )}
        ...
        <div className="text-center mt-8">
          <h1 className="gold-shine text-2xl font-extrabold tracking-wide">YOUR COMMAND CENTER</h1>
          {trialDaysLeft != null && (
