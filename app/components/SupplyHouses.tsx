      ...
      {canEdit && adding ? (
        <div className="mt-3 rounded-lg border border-slate-700 bg-slate-800/40 p-3">
          ...
          <div className="mt-2 flex gap-2">
            <button type="button" onClick={add} disabled={busy} className="rounded-md px-3 py-1.5 text-xs font-bold uppercase tracking-wide text-slate-900 disabled:opacity-60" style={{ background: "#e0a82e" }}>Save</button>
